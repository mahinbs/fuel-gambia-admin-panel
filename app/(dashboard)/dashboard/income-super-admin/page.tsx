      ...
      <div className="space-y-10 pb-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <Button 
            variant="outline" 
            size="lg" 
            className="bg-white dark:bg-slate-900 shadow-sm hover:shadow-md transition-all border-slate-200 dark:border-slate-800 h-16 px-8 rounded-2xl font-black uppercase tracking-widest text-xs"
          >
            <Download size={20} className="mr-2 text-blue-600" strokeWidth={3} />
          ...
          <Card className="relative overflow-hidden group border-none bg-white dark:bg-slate-900 p-8 shadow-2xl rounded-[2.5rem]">
            <div className="relative z-10">
              <div className="flex justify-between items-start">
                ...
                <Badge variant="warning" size="sm" className="font-black">7 New Pending</Badge>
              </div>
              <div className="mt-8">
          ...
          <Card className="relative overflow-hidden group border-none bg-white dark:bg-slate-900 p-8 shadow-2xl rounded-[2.5rem]">
            <div className="relative z-10">
              <div className="flex justify-between items-start">
                ...
                <Badge variant="success" size="sm" className="font-black">Verified</Badge>
              </div>
              <div className="mt-8">
          ...
          <div className="overflow-x-auto">
            <Table>
              <TableHead className="bg-slate-50/50 dark:bg-slate-800/50">
                <TableRow>
                  <TableHeader className="py-5 px-8 text-[10px] font-black uppercase tracking-widest text-slate-400">Partner Institution</TableHeader>
                  <TableHeader className="py-5 px-8 text-[10px] font-black uppercase tracking-widest text-slate-400">Gross Amount</TableHeader>
                  <TableHeader className="py-5 px-8 text-[10px] font-black uppercase tracking-widest text-slate-400">Payment Window</TableHeader>
                ...
                {transactions.map((t) => (
                  <TableRow key={t.id} className="group hover:bg-white dark:hover:bg-slate-800/50 transition-colors">
                    ...
                    <TableCell className="py-6 px-8 text-right">
                      <Badge variant={t.status === 'RECEIVED' ? 'success' : 'warning'} size="sm" className="font-black px-3 py-1 rounded-lg">
                        {t.status}
                      </Badge>
                    </TableCell>
                  </TableRow>
