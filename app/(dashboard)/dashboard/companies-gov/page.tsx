        ...
        >
          <form className="space-y-6" onSubmit={handleOnboard}>
            ...
            <div className="pt-4 flex gap-4">
              ...
              <Button variant="primary" type="submit" className="flex-1 py-4 shadow-xl shadow-blue-500/20 font-black tracking-widest h-14 rounded-2xl uppercase text-[10px]">
                Complete Onboarding
              </Button>
            </div>
          </form>
          ...
          {selectedCompany && (
            <div className="space-y-8">
              ...
              <div className="pt-4 flex gap-4">
                ...
                <Button variant="primary" className="flex-1 py-4 shadow-xl shadow-blue-500/20 font-black tracking-widest h-14 rounded-2xl uppercase text-[10px]">
