...
export default function NotificationsStationManagerPage() {
    ...
    <ProtectedRoute requiredRole={AdminRole.STATION_MANAGER}>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Notifications - Station Manager</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">Station operations and inventory notifications</p>
          </div>
        ...
        <Card>
          <div className="space-y-4">
            {loading ? (
              ...
              notifications
                .filter((n) => ['LOW_STOCK', 'PAYMENT', 'SETTLEMENT'].includes(n.type))
                .map((notification) => (
                  <div
                    key={notification.id}
